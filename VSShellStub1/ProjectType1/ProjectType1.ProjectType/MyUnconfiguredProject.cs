...
namespace ProjectType1
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "ProjectType1", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "myproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "ProjectType1";

        internal const string Language = "ProjectType1";
