...
namespace ProjectType1 {
	...
	internal partial class foo {
		...
		internal const string SchemaName = "foo";
		...
		internal const string PrimaryDataSourceItemType = "fooCompile";
		...
		/// <summary>Initializes a new instance of the foo class.</summary>
		internal foo(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule) {
			this.rule = rule;
		}
		
		/// <summary>Initializes a new instance of the foo class.</summary>
		internal foo(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs, string context, string file, string itemType, string itemName) : 
		...
		/// <summary>Initializes a new instance of the foo class.</summary>
		internal foo(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule, Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject) : 
				this(rule) {
			if ((rule == null)) {
		...
		private void InitializeFallbackRule() {
			...
			Microsoft.Build.Framework.XamlTypes.Rule unboundRule = foo.deserializedFallbackRule;
			if ((unboundRule == null)) {
				System.IO.Stream xamlStream = null;
				System.Reflection.Assembly thisAssembly = System.Reflection.Assembly.GetExecutingAssembly();
				try {
					xamlStream = thisAssembly.GetManifestResourceStream("XamlRuleToCode:foo.xaml");
					...
					; ((unboundRule == null) 
						...
						if (System.StringComparer.OrdinalIgnoreCase.Equals(t.Name, SchemaName)) {
							unboundRule = t;
							unboundRule.Name = "ef15f1c2-fa2b-4db5-a137-c534767b3c80";
							foo.deserializedFallbackRule = unboundRule;
						}
					}
				}
				finally {
	...
	internal partial class ProjectProperties {
		...
		private static System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, foo> CreatefooPropertiesDelegate = new System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, foo>(CreatefooProperties);
		
		private static foo CreatefooProperties(System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>> namedCatalogs, object state) {
			ProjectProperties that = ((ProjectProperties)(state));
			return new foo(that.ConfiguredProject, namedCatalogs.Result, "Project", that.File, that.ItemType, that.ItemName);
		}
		
		/// <summary>Gets the strongly-typed property accessor used to get and set foo build items properties.</summary>
		internal System.Threading.Tasks.Task<foo> GetfooPropertiesAsync() {
			...
			return namedCatalogsTask.ContinueWith(CreatefooPropertiesDelegate, this, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskContinuationOptions.ExecuteSynchronously, System.Threading.Tasks.TaskScheduler.Default);
		}
	}
}
