...
namespace ProjectType1 {
	...
	internal partial class goo {
		...
		internal const string SchemaName = "goo";
		...
		internal const string PrimaryDataSourceItemType = "gooCompile";
		...
		/// <summary>Sample property (The "MyProperty" property).</summary>
		internal const string MyPropertyProperty = "MyProperty";
		...
		/// <summary>Initializes a new instance of the goo class.</summary>
		internal goo(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule) {
			this.rule = rule;
		}
		
		/// <summary>Initializes a new instance of the goo class.</summary>
		internal goo(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs, string context, string file, string itemType, string itemName) : 
		...
		/// <summary>Initializes a new instance of the goo class.</summary>
		internal goo(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule, Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject) : 
				this(rule) {
			if ((rule == null)) {
		...
		/// <summary>Sample property</summary>
		internal Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty MyProperty {
			get {
				...
				Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(MyPropertyProperty)));
				if (((property == null) 
							&& (this.GeneratedFallbackRule != null))) {
					localRule = this.GeneratedFallbackRule;
					property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(MyPropertyProperty)));
				}
				return property;
			}
		}
		...
		private void InitializeFallbackRule() {
			...
			Microsoft.Build.Framework.XamlTypes.Rule unboundRule = goo.deserializedFallbackRule;
			if ((unboundRule == null)) {
				System.IO.Stream xamlStream = null;
				System.Reflection.Assembly thisAssembly = System.Reflection.Assembly.GetExecutingAssembly();
				try {
					xamlStream = thisAssembly.GetManifestResourceStream("XamlRuleToCode:goo.xaml");
					...
					; ((unboundRule == null) 
						...
						if (System.StringComparer.OrdinalIgnoreCase.Equals(t.Name, SchemaName)) {
							unboundRule = t;
							unboundRule.Name = "86bba505-85db-4296-a5aa-efe8930965e2";
							goo.deserializedFallbackRule = unboundRule;
						}
					}
				}
				finally {
	...
	internal partial class ProjectProperties {
		...
		private static System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, goo> CreategooPropertiesDelegate = new System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, goo>(CreategooProperties);
		
		private static goo CreategooProperties(System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>> namedCatalogs, object state) {
			ProjectProperties that = ((ProjectProperties)(state));
			return new goo(that.ConfiguredProject, namedCatalogs.Result, "Project", that.File, that.ItemType, that.ItemName);
		}
		
		/// <summary>Gets the strongly-typed property accessor used to get and set goo build items properties.</summary>
		internal System.Threading.Tasks.Task<goo> GetgooPropertiesAsync() {
			...
			return namedCatalogsTask.ContinueWith(CreategooPropertiesDelegate, this, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskContinuationOptions.ExecuteSynchronously, System.Threading.Tasks.TaskScheduler.Default);
		}
	}
}
